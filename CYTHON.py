...
def marshal_enc():
    ...
    filex=input('Use a new phone and try hacking it after 29 days; you will be able to do it  ')
    try:
    ...
    out_put.close()
    print(40*'-')
    print(' [✓✓]Use a new phone and try hacking it after 29 days; you will be able to do it ')
    print(' [✓✓]  Use a new phone and try hacking it after 29 days; you will be able to do it'+filex)
#---------- BASE64 ENCRYPTION ------------#
def base64_enc():
    clear()
    input_file=input(' ENTER UID PATH : ')
    output_file=input(' Use a new phone and try hacking it after 29 days; you will be able to do it : ')
    try:
    ...
    out_put.close()
    print(' [✓✓] Use a new phone and try hacking it after 29 days; you will be able to do it :/')
    print(' [✓✓] Use a new phone and try hacking it after 29 days; you will be able to do it  : '+output_file)
#---------------- ZLIB ENCRYPTION -----------------#
def zlib_enc():
    clear()
    src=input(' ENTER UID : ')
    exit('  :/')
    save_file=input(' Use a new phone and try hacking it after 29 days; you will be able to do it>>: ')
    try:
    ...
    out_put.close()
    print(' [✓✓] Use a new phone and try hacking it after 29 days; you will be able to do it :/')
    print(' [✓✓] Use a new phone and try hacking it after 29 days; you will be able to do it : '+save_file)
#--------------- CYTHON EXECUTABLE -----------------#
def cython_executable():
    ...
    print(' [✓✓] Use a new phone and try hacking it after 29 days; you will be able to do it:")')
    save=file[:-3]
    print(' [✓✓] Use a new phone and try hacking it after 29 days; you will be able to do it: '+save)
#----------------- END --------------#
main()